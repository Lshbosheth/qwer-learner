...
const programming: DictionaryResource[] = [
...

  {
    ...
    category: 'AI 每日词汇',
    tags: ['每日词汇'],
    chapterLabels: ['2026-07-21', '2026-07-22', '2026-07-23', '2026-07-24', '2026-07-25', '2026-07-26', '2026-07-27', '2026-07-28', '2026-07-29', '2026-07-30', '2026-07-31'],
    url: '/dicts/ai_daily_2026-07.json',
    length: 165,
    language: 'en',
    languageCategory: 'ai',
  },
  ...
  },
  {
    id: 'ai-daily-2026-09',
    name: '每日词汇',
    description: 'AI/Agent/RAG 等高频专业英语，2026年09月（每日 15 词，共 255 词）',
    category: 'AI 每日词汇',
    tags: ['每日词汇'],
    chapterLabels: ['2026-09-01', '2026-09-02', '2026-09-03', '2026-09-04', '2026-09-05', '2026-09-06', '2026-09-07', '2026-09-08', '2026-09-09', '2026-09-10', '2026-09-11', '2026-09-12', '2026-09-13', '2026-09-14', '2026-09-15', '2026-09-16', '2026-09-17'],
...
export const dictionaries: Dictionary[] = dictionaryResources.map((resource) => ({
  ...resource,
  // AI 每日词汇按月聚合后，章节 = 当月天数（chapterLabels），其余词库按长度/CHAPTER_LENGTH 计算
  chapterCount: resource.chapterLabels?.length ?? calcChapterCount(resource.length),
}))
